...
import (
	...
	extHello "github.com/ujangpudin04/riuba-proto/protogen/hello"
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extHello.HelloServiceServer) error {
	...
	mux.Handle(http.MethodPost, pattern_HelloService_SayManyHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
