...
const (
	...
	UserService_GetListUser_FullMethodName = "/user.UserService/GetListUser"
...
type UserServiceClient interface {
	...
	GetListUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetListUserResponse, error)
	UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	DeleteUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetListUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetListUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	GetListUser(context.Context, *emptypb.Empty) (*GetListUserResponse, error)
	UpdateUser(context.Context, *UpdateUserRequest) (*UserResponse, error)
	DeleteUser(context.Context, *GetUserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) GetListUser(context.Context, *emptypb.Empty) (*GetListUserResponse, error) {
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *GetUserRequest) (*UserResponse, error) {
...
func _UserService_GetListUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetListUser(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
